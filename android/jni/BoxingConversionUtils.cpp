...
{
template<typename T>
::jni::JniReference<jobject>
box_value_in_object( JNIEnv* env, const char* className, const char* signature, T param )
{
    auto javaClass = ::jni::find_class(env, className );
    auto theConstructor = env->GetMethodID( javaClass.get(), "<init>", signature );
    return ::jni::new_object(env, javaClass, theConstructor, param );
}

jint
unbox_short_value( JNIEnv* env, const ::jni::JniReference<jobject>& jvalue )
{
    auto javaIntegerClass = ::jni::find_class( env, "java/lang/Short" );
    auto intValueMethodId = env->GetMethodID( javaIntegerClass.get(), "shortValue", "()S" );
    return ::jni::call_java_method<jshort>( env, jvalue, intValueMethodId );
}

jint
unbox_int_value( JNIEnv* env, const ::jni::JniReference<jobject>& jvalue )
{
    auto javaIntegerClass = ::jni::find_class( env, "java/lang/Integer" );
    auto intValueMethodId = env->GetMethodID( javaIntegerClass.get(), "intValue", "()I" );
    return ::jni::call_java_method<jint>( env, jvalue, intValueMethodId );
}

jlong
unbox_long_value( JNIEnv* env, const ::jni::JniReference<jobject>& jvalue )
{
    auto javaLongClass = ::jni::find_class( env, "java/lang/Long" );
    auto longValueMethodId = env->GetMethodID( javaLongClass.get(), "longValue", "()J" );
    return ::jni::call_java_method<jlong>( env, jvalue, longValueMethodId );
}
...
{
    auto javaClass = ::jni::find_class(env, "java/lang/Long" );
...
{
    auto javaClass = ::jni::find_class(env, "java/lang/Short" );
...
{
    auto javaClass = ::jni::find_class(env, "java/lang/Integer" );
