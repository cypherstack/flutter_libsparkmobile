...
{
    delete get_pointer<::Locale>(handle);
}
...
locale_get_language_code(_baseRef handle)
{
    return Conversion<std::optional<std::string>>::toBaseRef(
        get_pointer<::Locale>(handle)->language_code
    );
}
...
{
    return Conversion<std::optional<std::string>>::toBaseRef(
        get_pointer<::Locale>(handle)->country_code
    );
}
...
{
    return Conversion<std::optional<std::string>>::toBaseRef(
        get_pointer<::Locale>(handle)->script_code
    );
}
...
{
    return Conversion<std::optional<std::string>>::toBaseRef(
        get_pointer<::Locale>(handle)->language_tag
    );
}
...
{
    return reinterpret_cast<_baseRef>(
        new (::std::nothrow) std::optional<::Locale>(
            *get_pointer<::Locale>(locale_handle)
        )
    );
}
...
{
    delete reinterpret_cast<std::optional<::Locale>*>(handle);
}
...
{
    return reinterpret_cast<_baseRef>(
        &**reinterpret_cast<std::optional<::Locale>*>(handle)
    );
}
