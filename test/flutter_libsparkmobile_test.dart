...
void main() {
  final FlutterLibsparkmobilePlatform initialPlatform =
      FlutterLibsparkmobilePlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterLibsparkmobilePlatform fakePlatform =
        MockFlutterLibsparkmobilePlatform();
